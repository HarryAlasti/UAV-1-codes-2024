% Matlab code to generate the random snapshot
...
Ss = 15;                                                                  % for Laplace-like                  % std of the small scale Gaussians
...
for Wnum = 1 : M
    ...
    save(name,'Data', 'P','Ps','Sigma','Ss','N','Ns','Peak', 'xx', 'p', 'MaxMin'); 
    z = [z;Z(:)];
end
